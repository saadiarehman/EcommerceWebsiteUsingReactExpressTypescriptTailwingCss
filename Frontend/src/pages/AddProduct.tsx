    ...
    <>
      ...
      <div className="h-full w-full flex items-center justify-center ">
          ...
          <div className="mt-4">
            ...
            <textarea id="textarea" name="textarea" className="w-full h-32 px-3 py-2 border border-gray-500 rounded-md text-gray-700"></textarea>
          </div>
          <div className="mt-4">
            ...
            <div className="mt-5 flex items-center justify-end w-full">
              <button className="shadow-gray-500 shadow-sm border p-3 w-1/5 
